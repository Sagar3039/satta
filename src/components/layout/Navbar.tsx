      ...
      <div className="container mx-auto px-4 py-3">
        <nav className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo.jpg" alt="Satta King Logo" className="h-12 w-12 rounded-full border-2 border-gold hover:border-white/50 transition-colors" />
        ...
        <div className="md:hidden bg-secondary/95 backdrop-blur-sm">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
            ...
            <Button 
              ...
              className="bg-gold hover:bg-gold-light text-black font-semibold flex items-center justify-center"
            >
              <PhoneCall className="mr-2 h-4 w-4" />
              Contact for Betting
            </Button>
